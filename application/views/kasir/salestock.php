    ...
    <form action="<?= base_url('kasir/updatesale'); ?>" method="post" name="autoSumForm">
        ...
        <div class="modal-body ml-5 mr-5">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="transaction_id" name="transaction_id" placeholder="Transaction id" Value="P-">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tmedicine_qty" name="tmedicine_qty" placeholder="0" onfocus="startCalc();" onblur="stopCalc();" readonly>
            </div>
            <div class="form-group">
